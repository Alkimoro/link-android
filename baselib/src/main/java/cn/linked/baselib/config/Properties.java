...
public class Properties {
    ...
    public static final String HTTP_SERVER_URL = "www.xxx.com/";
    public static final String HTTP_SERVER_DEBUG_URL = "localhost:8443/";

    public static final String CHAT_CLIENT_HOST = "49.234.70.153";
    public static final int CHAT_CLIENT_PORT = 8090;
    public static final String CHAT_CLIENT_DEBUG_HOST = "localhost";
